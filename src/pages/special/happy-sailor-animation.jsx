    ...
    <header className={clsx("hero hero--primary", styles.heroBanner)}>
      <div className="container">
        ...
        <p className="hero__subtitle">
          Happy Sailor Animation Brought to You by Comp Labs. Credits for this
          Animation goes to{" "}
          <a href="https://codepen.io/tuckermassad/pen/XWVwzax" target="_blank">
            @tuckermassad
          </a>{" "}
          at CodePen.
        </p>
...
export default function SailorAnimation() {
  ...
  return (
    ...
    >
      ...
      <main>
        <iframe
          src="/html/sailor.html"
          title="Happy Sailor Animation"
          width="100%"
          height="500"
        ></iframe>
        <center>
          <a
            href="https://codepen.io/rudrasen2/pen/zYRxPBr"
            target="_blank"
