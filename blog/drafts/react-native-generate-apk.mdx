...
image: '/img/blog/react-native-generate-apk.png'
...
**As a result, the APK creation process is done. You can find the generated APK at `android/app/build/outputs/apk/app-release.apk`. This is the actual app, which you can send to your phone, but you need an `AAB` File to Publish Your App to the Google Play Store.**
