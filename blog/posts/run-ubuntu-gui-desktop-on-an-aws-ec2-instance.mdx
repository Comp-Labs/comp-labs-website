...
- Access to an AWS EC2 instance using `PuTTY (or any other SSH CLient)` | This guide assumes that you’re logged into the machine using SSH
...
**Let’s install Ubuntu Desktop and TightVNC on your EC2 Instance. After logging in to your EC2 instance using the Terminal or the SSH Client, enter the following commands to install the tools that will be required to run Ubuntu Desktop:**
...
**After you’re done, enter `Ctrl + :` or `Esc + :` and type `wq` to save and quit the file.**
...
**Congratulations! you’re done with the configuration for Ubuntu Desktop. Now Perform the Next Steps below:**
...
<iframe src="/subscribe.html" title="Subscribe Comp Labs" height="70"></iframe>

## Finding Help

If you get Stuck Anywhere, Please Feel Free to Find or Ask Help in one of These Forums/Methods:

- [Ask Ubuntu](https://askubuntu.com/)
- [Ubuntu Forums](https://ubuntuforums.org/)
- [IRC-based Support](https://wiki.ubuntu.com/IRC/ChannelList)
- [Contact Comp Labs](https://forms.gle/dQmrNAZZ1KK81rAP7)