...
The moment your changes to the code is done, open Windows Search (<kbd><i class="fa-brands fa-windows"></i></kbd> + S) and search for Command Prompt and run it as Administrator.
