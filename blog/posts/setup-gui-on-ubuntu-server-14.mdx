...
Open Remote Desktop Connection by pressing <kbd><i class="fa-brands fa-windows" /></kbd> + R and type `mstsc` and press Enter. Then Type in your EC2 Instance Public IP Address and press Enter. Then type in your username as `ubuntu` and password as you set earlier. Then click on **OK**.
