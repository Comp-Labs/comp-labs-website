...
# How to Install macOS Montrey 12.4 in Oracle VM VirtualBox (Windows)
...
Next, we need to increase the number of processors. Under System Tab, Click on Processor tab above, go there and increase it to at least 2 processors.
...
We also need to increase the video memory for our VM. To increase it, go to the Display tab and take it all the way up to the last which is 128 MB.
