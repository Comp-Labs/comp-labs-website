...
- [VirtualBox Configuration Code](//techfiddle.org)
- [Download macOS Monterey ISO Image](//techfiddle.org)
...
<details>
  ...
  <br />
  This command is executed with the command prompt configuration steps listed [above](#run-virtualbox-code-using-command-prompt)
</details>
