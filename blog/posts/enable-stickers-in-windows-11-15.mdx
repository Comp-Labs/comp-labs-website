...
To Enable Stickers, you need to just press <kbd><i class="fa-brands fa-windows"></i></kbd> + R, type `regedit`, press enter, and select `Yes` in the User Account Control Prompt.
