...
To Enable Stickers, you need to just press <i class="fa-brands fa-microsoft"></i> + R, type `regedit`, press enter, and select `Yes` in the User Account Control Prompt.
